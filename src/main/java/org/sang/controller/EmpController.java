...
import org.sang.common.PoUtils;
...
public class EmpController {
    ...
    public Map<String,Object> getEmployeeByPage(
            ...
            Long jobLevelId,String engageForm,Long departmentId,
            String beginDateScope){
        Map<String,Object> map = new HashMap<>();
        List<Employee> employeeByPage = empService.getEmployeeByPage(page,size,keywords,politicId,nationId,posId,jobLevelId,engageForm,
    ...
    public ResponseEntity<byte[]> exportEmp(){
        return PoUtils.exportEmp2Excel(empService.getAllEmployees());
    }
    ...
    @RequestMapping(value = "/ckemp",method = RequestMethod.GET)
    public Map<String,Object> getEmployeeById(int id){
        Map<String, Object> map = new HashMap<>();
        map.put("emp",empService.getEmployeeById(id));
        return map;
    }

    @RequestMapping(value = "/importEmp",method = RequestMethod.POST)
    public RespBean importEmp(MultipartFile file){
        List<Employee> emps = PoUtils.importEmp2List(file,
                empService.getAllNations(),empService.getAllPolitics(),departmentService.getAllDeps(),
